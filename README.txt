...
Install
-------
Download the repo as zip (or go to downloads in https://bitbucket.org/Opvolger/xbmc.addon.uzg/downloads)
...
My work (unstable) https://bitbucket.org/Opvolger/xbmc.addon.uzg (hg repo).
